...
export function AgentsSidebar({
  ...
  const sidebarContent = (
    ...
    >
      ...
      {/* My Agents - Navigation to agent config page */}
      <div className="px-2 pb-3 flex-shrink-0 space-y-0.5 -mx-1">
        <Tooltip delayDuration={500}>
          <TooltipTrigger asChild>
            <ButtonCustom
              onClick={() => setDesktopView("my-agents")}
              variant="ghost"
              size="sm"
              className="w-full justify-start h-7 px-2 text-sm text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg gap-2"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
                <path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1.07A7.001 7.001 0 0 1 13 23h-2a7.001 7.001 0 0 1-6.93-6H3a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2Z" />
          ...
          <TooltipContent side="right">
            <span>Manage your AI agents</span>
          </TooltipContent>
        </Tooltip>
      </div>
