...
export const subChats = sqliteTable("sub_chats", {
  ...
  mode: text("mode").notNull().default("auto"), // "auto" | "plan"
  runtimeId: text("runtime_id").default("claude"), // ACP runtime ID (e.g., "claude", "goose", "codex")
...
// Re-export agent collaboration tables
